...
export class ListSettlementsQueryDto {
  ...
  @ApiPropertyOptional({
    example: 'CONFIRMED',
    enum: ['CONFIRMED', 'REVERSED', 'FAILED'],
    description: 'Settlement status filter.',
  })
  @IsOptional()
  @IsIn(['CONFIRMED', 'REVERSED', 'FAILED'])
  status?: string;

  @ApiPropertyOptional({
    example: 'BRL',
    enum: ['BRL', 'USD'],
    description: 'Payment currency code filter.',
  })
  @IsOptional()
  @IsIn(['BRL', 'USD'])
  currencyCode?: string;
  ...
  @ApiPropertyOptional({
    example: '2026-06-01',
    description: 'Minimum settlement date filter.',
  })
  @IsOptional()
  @IsDateString()
  ...
  @ApiPropertyOptional({
    example: '2026-06-30',
    description: 'Maximum settlement date filter.',
  })
  @IsOptional()
  @IsDateString()
